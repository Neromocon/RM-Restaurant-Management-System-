...
namespace _RM.Model
{
    public partial class frmWaiterSelect : Form
    {
        ...
        {
            string qry = "Select * from staff where sRole Like '웨이터'";
            // staff안에 있는 sRole에 저장된 이름 여기선 '웨이터'를 잘 확인 해야함.
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                b.Width = 150;
                b.Height = 50;
                b.FillColor = Color.FromArgb(100, 149, 237);
                b.HoverState.FillColor = Color.FromArgb(196, 228, 255);
